...
offset_range = 10  # [ppm]
num_offsets = 21  # 100  # number of measurements (not including M0)
...
sat_b1 = 1  # mean sat pulse b1 [uT]
t_p = 20e-3  # sat pulse duration [s]
t_d = 5e-3  # delay between pulses [s]
n_pulses = 10  # number of sat pulses per measurement
b0 = 3  # B0 [T]
spoiling = 1  # 0=no spoiling, 1=before readout, Gradient in x,y,z

seq_filename = 'example_test.seq'  # filename
